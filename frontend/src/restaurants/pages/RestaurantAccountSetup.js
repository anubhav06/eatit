...
const RestaurantAccountSetup = () => {
    ...
    useEffect(() => {
        ...
        let getAccountInfo = async() =>{
            let response = await fetch(`/partner-with-us/create-stripe-account/get-details/`, {
                method:'GET',
                headers:{
    ...
    let createStripeAccount = async() =>{
        setDisabled(true)
        let response = await fetch(`/partner-with-us/create-stripe-account/`, {
            method:'POST',
            headers:{
                'Content-Type':'application/json',
                // Provide the authToken when making API request to backend to access the protected route of that user
    ...
    let completeStripeAccount = async() =>{
        setDisabled(true)
        let response = await fetch(`/partner-with-us/complete-stripe-account/`, {
            method:'POST',
            headers:{
                'Content-Type':'application/json',
                // Provide the authToken when making API request to backend to access the protected route of that user
